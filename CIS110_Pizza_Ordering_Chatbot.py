...
while keepGoing.lower() =="y":
    ...
    print("_" * 10)
    print("Your order has been received. ETA is 3 minutes!")
    ...
    keepGoing = input("Would you like to place another order? Please enter y or n: ")
    while keepGoing.lower() not in ["y", "n"]:
        keepGoing = input("Invalid value: Please enter either a y or n:")
